...
<Tabs>
  ...
  <TabItem label="pnpm">
    ```bash
    pnpm add -g @a3t/rapid-cli
    ```
  </TabItem>
  <TabItem label="yarn">
    ```bash
    yarn global add @a3t/rapid-cli
    ```
  </TabItem>
</Tabs>
...
<Aside type="tip">
  If you don't use 1Password, RAPID also supports HashiCorp Vault or plain environment variables. See [Secrets Management](/guides/secrets-management/) for details.
</Aside>
