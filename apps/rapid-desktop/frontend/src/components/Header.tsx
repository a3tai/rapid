    ...
    <header className="h-14 bg-rapid-surface border-b border-rapid-border flex items-center justify-between px-6 wails-drag">
      ...
      <div className="flex items-center gap-4 wails-no-drag">
        <div>
          ...
          {viewInfo.subtitle && (
            <p className="text-xs text-rapid-muted">{viewInfo.subtitle}</p>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 wails-no-drag">
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          >
            <div className={clsx('status-dot', activeAgents > 0 ? 'status-dot-active' : 'status-dot-offline')} />
            <span className="text-rapid-muted">
              <span className="text-rapid-text font-medium">{activeAgents}</span> agent{activeAgents !== 1 ? 's' : ''}
            </span>
          </button>
